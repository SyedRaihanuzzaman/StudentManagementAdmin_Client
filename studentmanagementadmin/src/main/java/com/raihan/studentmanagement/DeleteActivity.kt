...
import com.raihan.studentmanagement.databinding.ActivityDeleteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(binding.root)
          ...
          binding.deleteBtn.setOnClickListener {
              val name = binding.dnameEtxt.text.toString()
              val phone = binding.dphoneEtxt.text.toString()
